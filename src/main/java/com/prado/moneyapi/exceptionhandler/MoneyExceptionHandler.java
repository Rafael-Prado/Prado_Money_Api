package com.prado.moneyapi.exceptionhandler;
...
public class MoneyExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<Object> HandlerDataViolationException(EmptyResultDataAccessException ex, WebRequest request){
