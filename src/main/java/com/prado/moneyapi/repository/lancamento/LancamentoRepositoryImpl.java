...
import com.prado.moneyapi.model.Categoria_;
import com.prado.moneyapi.model.Lancamento;
import com.prado.moneyapi.model.Lancamento_;
import com.prado.moneyapi.model.Pessoa_;
...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery {
	...
	public Page<Lancamento> filtrar(LancamentoFilter lancamentoFilter, Pageable page) {
		...
		adionarRestricoesdePaginacoa(query, page);
	...
	private void adionarRestricoesdePaginacoa(TypedQuery<?> query, Pageable page) {
		int paginaAtual = page.getPageNumber();
		int totalRegistroPagina = page.getPageSize();
